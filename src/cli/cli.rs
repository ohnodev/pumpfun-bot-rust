...
mod tests {
    ...
    fn test_basic_cli_parsing() {
        // Test buy command
        let args = vec!["pumpfun-bot", "buy", "token123", "1000000"];
        ...
        let args = vec!["pumpfun-bot", "buy", "token123", "1000000", "--priority-fee", "3"];
        let cli = Cli::parse_from(args);
        match cli.command {
            Commands::Buy { token_address, amount, priority_fee } => {
                assert_eq!(token_address, "token123");
        ...
        let args = vec!["pumpfun-bot", "sell", "token123", "50%"];
        let cli = Cli::parse_from(args);
        match cli.command {
        ...
        let args = vec!["pumpfun-bot", "sell", "token123", "30000"];
        let cli = Cli::parse_from(args);
        match cli.command {
            Commands::Sell { token_address, amount, priority_fee } => {
                assert_eq!(token_address, "token123");
        ...
        let args = vec!["pumpfun-bot", "sell", "token123", "30000", "--priority-fee", "3"];
        let cli = Cli::parse_from(args);
        match cli.command {
            Commands::Sell { token_address, amount, priority_fee } => {
                assert_eq!(token_address, "token123");
    ...
    fn test_priority_fee_must_be_integer() {
        ...
        let args = vec!["pumpfun-bot", "buy", "token123", "1000000", "--priority-fee", "3.5"];
